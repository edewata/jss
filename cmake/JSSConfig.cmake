...
macro(jss_config_java)
    ...
    list(APPEND JSS_JAVAC_FLAGS "--add-reads")
    list(APPEND JSS_JAVAC_FLAGS "jss=ALL-UNNAMED")
...
macro(jss_config_tests)
    ...
    list(APPEND JSS_TEST_JAVAC_FLAGS "--add-reads")
    list(APPEND JSS_TEST_JAVAC_FLAGS "jss=ALL-UNNAMED")
